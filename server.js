...
// will use regex to allow all different subdomains being generated by vercel!
const corsOptions = {
    origin: function (origin, callback) {
        const allowedPattern = /^https:\/\/my-math-frontend(-[a-z0-9]+)?\.baileym8203s-projects\.vercel\.app$/;
